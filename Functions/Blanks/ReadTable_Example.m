...
Path = 'C:\Users\amand\Documents\MATLAB\'; % Adjust to your specific folder path

Instron = 1;  %if you used the instron or texture analyzer, set 'Instron = 1' to invoke formatting options for those csv's.
